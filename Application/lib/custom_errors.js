//  We extend `Error.prototype`(simplest with ES6 class syntax)
//  Set `name` and `message` in the constructor method of each custom error type 
...
// Method checks if user trying to modify a resource is owner of resource, and throws an error if not
...
// if client passes an ID that isn't in the DB, we want to return 404
